...
<body>
        ...
        <div class="contact-form-container">
            <div class="container">
                ...
                <div class="column form-column">
                    <h1 class="Titulo-form">Contáctanos</h1>
                    <p>Si tienes alguna duda o sugerencia, puedes contactarnos y te responderemos lo antes posible.</p>

                    <form action="procesar_formulario.php" method="post" id="contactForm">
                        <label for="nombre">Nombre completo*</label>
                        <input type="text" id="nombre" name="nombre" required pattern="[a-zA-Z\s]+" title="Solo se permiten letras y espacios.">

                        <label for="email">Email*</label>
                        <input type="email" id="email" name="email" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="Debe ingresar un email válido.">

                        <label for="telefono">Teléfono*</label>
                        <input type="number" id="telefono" name="telefono" required pattern="[0-9]+" title="Solo se permiten números." min="2000000" max="79999999">

                        <label for="comentarios">Comentarios</label>
                        <textarea id="comentarios" name="comentarios"></textarea>

                        <div class="captcha">
                            <div class="g-recaptcha" data-sitekey="tu_clave_de_recaptcha"></div>
                        </div>
    ...
    <script src="{{ asset('JS/valida_tel.js') }}"></script>
